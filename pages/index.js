                ...
                <div className="flex-1 space-y-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="bg-green-600 text-white text-xs px-2 py-1 rounded-full font-medium">Coming Soon</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[#232323] p-4 rounded-xl border border-[#444] hover:scale-105 transition-all duration-300 cursor-pointer" style={{
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h4 className="font-semibold text-white">Smart Sleep Detection</h4>
                      </div>
                      <p className="text-gray-400 text-sm">Phone activity monitoring for intelligent wake-up timing</p>
                    </div>
                    
                    <div className="bg-[#232323] p-4 rounded-lg border border-[#444]">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h4 className="font-semibold text-white">Quick Alarm</h4>
                      </div>
                      <p className="text-gray-400 text-sm">Instant alarm setting with one-tap functionality</p>
                    </div>
                    ...
                    <div className="bg-[#232323] p-4 rounded-lg border border-[#444]">
                      ...
                      <p className="text-gray-400 text-sm">Robust security measures to protect user data</p>
                    </div>
                    ...
                    <div className="bg-[#232323] p-4 rounded-lg border border-[#444]">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h4 className="font-semibold text-white">Firebase Integration</h4>
                      </div>
                      <p className="text-gray-400 text-sm">Real-time database sync across devices</p>
                    </div>
                  </div>
                  ...
                  <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
